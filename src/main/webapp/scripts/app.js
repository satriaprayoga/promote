...
var promoteApp = angular.module('promoteApp', ['http-auth-interceptor', 'tmh.dynamicLocale',
    'ngResource', 'ngRoute', 'ngCookies', 'promoteAppUtils', 'pascalprecht.translate', 'truncate', 'ngCacheBuster']);
